...
def cvx_dc(p, q, r_vector, x_vector, a_inv, a_matrix, r_matrix, x_matrix, v_min, v_max, nm, a0, v0, branch, bus):
...
def cvx_ac(p, q, r_vector, x_vector, a_inv, a_matrix, r_matrix, x_matrix, v_min, v_max, nm, a0, v0, branch, bus):
    ...
    for i in range(nm):
        ...
        constr = constr + [q[int(to_bus[i] - 2)] + q_flow[int(to_bus[i] - 2)] == q_flow_child_sum[i] +
                           x_vector[int(to_bus[i] - 2)] * l_line[int(to_bus[i] - 2)]]
...
def cvx_dc_qg(p, qc, r_vector, x_vector, a_inv, a_matrix, r_matrix, x_matrix, v_min, v_max, nm, a0, v0, branch, bus):
    ...
    for i in range(nm):
        ...
        constr = constr + [p_flow[int(to_bus[i] - 2)] == p_flow_child_sum[i] - p[int(to_bus[i] - 2)]]
        constr = constr + [qg[int(to_bus[i] - 2)] + q_flow[int(to_bus[i] - 2)] == q_flow_child_sum[i] + qc[int(to_bus[i] - 2)]]

        if from_bus[i] == 1:
            constr = constr + [v_node[int(to_bus[i] - 2)] == 1 - 2 * (r_vector[int(to_bus[i] - 2)] * p_flow[int(to_bus[i] - 2)] + x_vector[
                                       int(to_bus[i] - 2)] * q_flow[int(to_bus[i] - 2)])]


        else:
            constr = constr + [v_node[int(to_bus[i] - 2)] == v_node[int(from_bus[i] - 2)] - 2 * (
                                       r_vector[int(to_bus[i] - 2)] * p_flow[int(to_bus[i] - 2)] + x_vector[
                                   int(to_bus[i] - 2)] * q_flow[int(to_bus[i] - 2)])]
