...
def mpc(pf, beta):
    ...
    [2,   1,    1,   1.05,    0.95,    0,       0,       0,        0,         1.5*beta, 0,    1.5*beta, -1.5*beta],
    ...
    [11,  2,    10,  1.05,    0.95,    0.67*pf, 0.67*pf,   0.67*pfq,     0.67*pf,         0,        0,       0,       0],
    [12,  2,    11,  1.05,    0.95,    0.45*pf,  0.45*pf,  0.45*pfq,     0.45*pfq,         0,        0,       0,       0],
    [13,  2,    3,   1.05,    0.95,    0.89*pf,  0.89*pf,  0.89*pfq,     0.89*pfq,         0,        0,       0,      0],
    [14,  1,    4,   1.05,    0.95,    0,        0,      0,        0,         0,        0,       0,       0],
    [15,  2,    15,  1.05,    0.95,    0.07*pf,  0.07*pf,  0.07*pfq,     0.07*pfq,         0.4*beta, 0,       0.4*beta, -0.4*beta],
    [16,  2,    15,  1.05,    0.95,    0.67*pf,  0.67*pf,  0.67*pfq,     0.67*pfq,         1.5*beta, 0,       1.5*beta, -1.5*beta],
    [17,  1,    4,   1.05,    0.95,    0,        0,       0,       0,         0,        0,       0,       0],
    [18,  2,    20,  1.05,    0.95,    0.45*pf,  0.45*pf,  0.45*pfq,     0.45*pfq,         2.0*beta, 0,       2*beta, -2*beta],
    [19,  2,    21,  1.05,    0.95,   2.23*pf,   2.23*pf,  2.23*pfq,     2.23*pfq,         0, 0,       1*beta,       -1*beta],
    [20,  2,    19,  1.05,    0.95,   0.45*pf,   0.45*pf,   0.45*pfq,     0.45*pfq,        0,        0,       0,       0],
    [21,  2,    5,   1.05,    0.95,    0.2*pf,   0.2*pf,   0.2*pfq,     0.2*pfq,         0,        0,       0,       0],
    [22,  1,    6,   1.05,    0.95,    0,        0,       0,       0,         0,        0,       0,      0],
    [23,  2,    27,  1.05,    0.95,    0.13*pf,  0.13*pf,  0.13*pfq,     0.13*pfq,         0,        0,       0,       0],
    [24,  2,    28,  1.05,    0.95,    0.13*pf,  0.13*pf,  0.13*pfq,     0.13*pfq,         0,        0,       0,       0],
    [25,  2,    29,  1.05,    0.95,    0.2*pf,   0.2*pf,  0.2*pfq,     0.2*pfq,          0,        0,       0,       0],
    [26,  2,    30,  1.05,    0.95,    0.07*pf,  0.07*pf,  0.07*pfq,     0.07*pfq,         0,        0,       0,       0],
    [27,  2,    7,   1.05,    0.95,    0.13*pf,  0.13*pf, 0.13*pfq,     0.13*pfq,         0,        0,       0,      0],
    [28,  2,    32,  1.05,    0.95,    0.27*pf,  0.27*pf,  0.27*pfq,     0.27*pfq,        0,        0,       0,       0],
    [29,  2,    33,  1.05,    0.95,    0.2*pf,   0.2*pf,   0.2*pfq,     0.2*pfq,        0,        0,       0,       0],
    [30,  1,    8,   1.05,    0.95,    0,        0,       0,       0,         0,        0,       0,      0],
    [31,  2,    35,  1.05,    0.95,    0.27*pf,  0.27*pf,  0.27*pfq,     0.27*pfq,        0,        0,       0,       0],
    [32,  4,    35,  1.05,    0.95,    0,        0,       0,       0,         0,        0,       1.8,   1.8],
    [33,  2,    35,  1.05,    0.95,    0.45*pf,  0.45*pf,  0.45*pfq,     0.45*pfq,         0,        0,       0,       0],
    [34,  2,    8,   1.05,    0.95,    1.34*pf,  1.34*pf,  1.34*pfq,    1.34*pfq,        0,        0,       0,       0],
    [35,  2,    8,   1.05,    0.95,    0.13*pf,  0.13*pf,  0.13*pfq,      0.13*pfq,        0,        0,       0,       0],
    [36,  2,    8,   1.05,    0.95,    0.67*pf,  0.67*pf, 0.67*pfq,     0.67*pfq,        0,        0,       0,       0],
    [37,  2,    9,   1.05,    0.95,    0.13*pf,  0.13*pf,  0.13*pfq,     0.13*pfq,         0,        0,       0,       0],
    [38,  1,    42,  1.05,    0.95,    0,        0,       0,       0,         0,        0,       0,       0],
    [39,  2,    43,  1.05,    0.95,    0.45*pf,  0.45*pf,  0.45*pfq,     0.45*pfq,          0,        0,       0,       0],
    [40,  2,    43,  1.05,    0.95,    0.2*pf,   0.2*pf,  0.2*pfq,     0.2*pfq,         0,        0,       0,       0],
    [41,  2,    10,  1.05,    0.95,    0.45*pf,  0.45*pf, 0.45*pfq,    0.45*pfq,         0,        0,       0,       0],
